...
class Client implements ClientInterface
{
    ...
    public function shortnameToUnicodeCallback($m)
    {
        if ((!is_array($m)) || (!isset($m[1])) || (empty($m[1]))) {
            ...
            $unicode = array_search($shortname,$unicode_replace,false);
